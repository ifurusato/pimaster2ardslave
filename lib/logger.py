...
class Logger:
    '''
       A general-purpose logging facility based upon the Python
       logging library, tailored to look a bit like Java's Log4j,
       but with nicely-colored, formatted output.
    '''
